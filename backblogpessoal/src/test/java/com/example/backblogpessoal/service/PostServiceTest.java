...
class PostServiceTest {
    ...
    void deveCriarPostComSucesso() {
        ...
        User user = new User("Andre", USUARIO, "senha");
        user.setId(1L);
        ...
        PostResponse expected = new PostResponse(1L, "Titulo", "Texto", "05/05", USUARIO, TEMA, "Andre");
    ...
    void deveEditarPostComSucesso() {
        ...
        when(postMapper.toResponse(post)).thenReturn(
                new PostResponse(1L, "Novo Titulo", "Novo Texto", "05/05", USUARIO, TEMA, "Andre"));
    ...
    void deveExcluirPostComSucesso() {
        ...
        when(postRepository.findById(1L)).thenReturn(post);
        when(postMapper.toResponse(post)).thenReturn(
                new PostResponse(1L, "Titulo", "Texto", "05/05", USUARIO, TEMA, "Andre"));
    ...
    void deveBuscarTodosOsPosts() {
        Post post = new Post("Titulo", "Texto", new User("Andre", USUARIO, "senha"), new Tema(TEMA));
        post.setId(1L);
    ...
    void deveBuscarPorUsuarioETema() {
        ...
        when(postMapper.toResponseList(posts)).thenReturn(List.of(
                new PostResponse(1L, "Titulo", "Texto", "12/04", USUARIO, TEMA, "Andre")));
